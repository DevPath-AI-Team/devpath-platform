...
import './Login.css'; // Aynı tasarımı kullanıyoruz

// İKONLAR (Aynılarını kullanıyoruz)
const MailIcon = () => (
...
const UserIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="input-icon"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
);
const CodeIcon = () => (
...
const Register = () => {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    // Buraya ilerde backend isteği gelecek
    ...
    <div className="login-container">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <UserIcon />
                <input type="text" placeholder="Elon Musakka" className="styled-input" required />
              </div>
            </div>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <MailIcon />
                <input type="email" placeholder="ogrenci@iste.edu.tr" className="styled-input" required />
              </div>
            </div>
      ...
      <div className="login-right">
        ...
        <div className="right-content">
          <h2>Sınırları Zorla.</h2>
          <p>Yüzlerce yazılımcı adayı ile birlikte öğren, geliş ve geleceği inşa et.</p>
        </div>
      </div>
    </div>
  );
