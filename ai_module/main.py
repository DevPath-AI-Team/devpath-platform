...
# Bu endpoint root'ta çalışır (prefix olmadan) - Java backend için
...
if __name__ == "__main__":
    ...
    # CORS ayarları - Java backend erişimi için
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],
    ...
    # Java Integration - Root level /analyze endpoint
