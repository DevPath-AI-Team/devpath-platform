    ...
    return (
        <aside className="sidebar">
            ...
            <nav className="nav-menu">
                <div className={getNavItemClass('/dashboard')} onClick={() => handleNavigate('/dashboard')}><HomeIcon /> <span>Ana Panel</span></div>
                <div className={getNavItemClass('/roadmap')} onClick={() => handleNavigate('/roadmap')}><MapIcon /> <span>Yol Haritam</span></div>
                <div className={getNavItemClass('/courses')} onClick={() => handleNavigate('/courses')}><BookIcon /> <span>Tüm Dersler</span></div>
