    ...
    docs = {
        ...
        "endpoints": [
            ...
            },
            {
                ...
                "description": "Seviyeye uygun video önerileri (veritabanından)",
                "query_params": {
...
def get_video_recommendations(user_id):
    ...
    Video önerileri VERİTABANINDAN gelecek
    ...
    try:
        ...
        # Video önerilerini al (veritabanından gelecek)
        ...
        return jsonify({
            ...
            'data': {
                ...
                'videos': videos,
                'total': len(videos),
                'source': 'database',  # Veritabanından geldiğini belirt
...
if __name__ == '__main__':
    ...
    print(f"💾 Video önerileri veritabanından gelecek")
